...
CREATE TABLE questions (id INTEGER PRIMARY KEY AUTO_INCREMENT, is_enable BOOLEAN default false, question_type ENUM('short_answer', 'email', 'linear_scale') NOT NULL, question VARCHAR(512));
